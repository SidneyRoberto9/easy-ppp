...
import { ProductCustomizationSchemaFormType, productCustomizationSchema } from '@/schemas/products';
...
const ProductCustomizationForm = ({
  ...
  const form = useForm<ProductCustomizationSchemaFormType>({
  ...
  const onSubmit = async (values: ProductCustomizationSchemaFormType) => {
