...
import { ProductCountryDiscountsFormType, productCountryDiscountsSchema } from '@/schemas/products';
...
const CountryDiscountsForm = ({ productId, countryGroups }: CountryDiscountsFormProps) => {
  const { toast } = useToast();
  const form = useForm<ProductCountryDiscountsFormType>({
  ...
  const onSubmit = async (values: ProductCountryDiscountsFormType) => {
